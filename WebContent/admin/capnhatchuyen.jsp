...
<body>
          ...
          for(int i = 0; i<listError.size();i++)
			{
        	 	 if("LoiNgayDi".equals(listError.get(i))){
					out.print("Thời gian đi phải lớn hơn thời gian hiện tại"); break;
				}else if("LoiNgayDen".equals(listError.get(i))){
					out.print("Thời gian về phải lớn hơn thời gian hiện tại"); break;
				}else if("DiDen".equals(listError.get(i)) || "LoiTG".equals(listError.get(i))){
					out.print("Vui lòng kiểm tra lại thời gian đi và thời gian đến"); break;
				}}
	...
	<div class="col-md-9"  id="themchuyen">
       ...
       <form class="form-horizontal" role="form" action="CapNhatChuyenServlet" method="post">
        <div class="form-group">
          <label for="inputmatuyen" class="col-sm-4 control-label">Mã chuyến : (*) </label>
          <div class="col-sm-3">
          	<input type="hidden" name="maChuyen" value="<%=request.getAttribute("maChuyen")%>"> 
           <label for="maChuyen" class="control-label"><%=request.getAttribute("maChuyen")%> </label>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="tiLeOnline"   
         ...
         <label class="note"><% 
					...
					{ if("".equals(request.getAttribute("tiLeOnline"))){
						out.print("Vui lòng nhập tỉ lệ");break;
        ...
        <div class="form-group">
          ...
          <button type="submit" class="btn btn-info" name="capnhat"  value="capnhap">Cập Nhật</button>
          </div>
        </div>
      </form>
    </div>
